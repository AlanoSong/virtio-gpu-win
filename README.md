...
- According to the Windows Display Driver Model (WDDM) and DirectX specifications,  
a GPU driver consists of two components: KMD (Kernel Mode Driver) and UMD (User Mode Driver)
...
- On the **host machine**, open the Visual Studio solution `virtio-gpu-win.sln` under `build` folder.
...
- Method (2) will be described in detail in the following section.
